...
class HandleContext:
    ...
    def create_invest_mobile_replace(cls, data):
        ...
        if re.search(cls.invest_pattern, data):
            new_mobile = user_accounts.get_data('invest_use','mobilephone')
    ...
    def borrow_user_id_replace(cls, data):
        ...
        if re.search(cls.borrow_user_id_pattern, data):
            new_id = str(user_accounts.get_data('borw_user', 'id'))
            print(type(new_id))
    ...
    def admin_user_tel_replace(cls, data):
        ...
        if re.search(cls.admin_user_tel_pattern, data):
            new_mobile = user_accounts.get_data('admin_user', 'mobilephone')
    ...
    def borrow_user_tel_replace(cls, data):
        ...
        if re.search(cls. borrow_user_tel, data):
            new_mobile = user_accounts.get_data('borw_user', 'mobilephone')
    ...
    def invest_user_id_replace(cls, data):
        ...
        if re.search(cls.invest_user_id_pattern, data):
            new_mobile = str(user_accounts.get_data('invest_use', 'id'))
...
if __name__ == '__main__':
    ...
    data = '{"member_id":${invest_user_id}, "loan_id":${loan_id},"amount":300}'
    print(handle_context.loan_replace(data))
